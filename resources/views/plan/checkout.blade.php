                                ...
                                <form action="{{--route('donation')--}}"  method="post" id="payment-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="hidden" name="plan" id="hidden_price" name="hidden_price"  />
