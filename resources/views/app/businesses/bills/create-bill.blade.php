            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="total" name="total" value="{{ old('total') }}" oninput="calculate()" class="form-control"
                             min="0" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id='gst' name="gst" value="{{ old('gst') }}" oninput="calculate()" class="form-control"
                             min="0" required>
                    </div>
